...
var stuff = function() {
  ...
  var search = require('conceptNet');

  // these were ganked from dariusk's corpora project
  var animals = require('./animals')['animals']; // 134
  var greekMonsters = require('./greek_monsters')['greek_monsters']; // 24
  var monsters = require('./monsters')['names']; // 84
  ...
  for (var i = 0; i < target.length; i++) {
    console.log(target[i], search(target[i]));
  };
